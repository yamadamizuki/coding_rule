...
### スタイルをつける対象
	基本スタイルをつける際はclassに定義すること

### スタイルを定義する際の深さについて
	スタイルの記述は3階層までにする
	見栄えの良さやブラウザの読み込みスピードが改善されるため
...
### ルールとルールの改行について
	わかりやすくなるので極力改行するようにする
	関連性をつけるために改行しないなどは当人の判断でお願いいたします。

### プロパティのお願い
	不整合が起こりやすくなるため!importantはなるべく使用しないようにする。
---
